...
async function generateWorkflow(query, tools) {
  ...
  const prompt = `
You are an AI workflow architect. Create a complete workflow for the user's goal using the available tools.
...
Create a structured workflow with 3-5 steps. Each step should:
1. Have a clear action-oriented title
2. Have a description explaining what to do
3. Recommend 1-3 tools from the list with a STEP-SPECIFIC description for each tool
4. Include 2-3 pro tips for that step

Return JSON ONLY in this exact format:
{
  "workflow": {
    "title": "Descriptive workflow title (e.g., 'Social Media Content Automation Workflow')",
    "description": "A 1-2 sentence description of what this complete workflow accomplishes",
    "steps": [
      {
        "stepNumber": 1,
        "title": "Step title (e.g., 'Generate Content Ideas & Copy')",
        "description": "What to do in this step",
        "tools": [
          {
            "id": "tool-id-from-list",
            "stepDescription": "Brief description of how this tool helps with THIS specific step (e.g., 'Generate engaging content ideas and copy')"
          }
        ],
        "proTips": [
          "First pro tip for this step",
          "Second pro tip for this step",
          "Third pro tip for this step"
        ]
      }
    ]
  }
...
- Create 3-5 logical steps that flow naturally
- Each step should have 1-3 recommended tools
- stepDescription should be specific to how the tool helps with THAT step (not the tool's general tagline)
- Pro tips should be practical and actionable
